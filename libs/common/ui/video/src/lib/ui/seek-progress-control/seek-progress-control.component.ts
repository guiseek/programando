...
@Component({
  selector: 'ui-seek-progress-control',
  templateUrl: './seek-progress-control.component.html',
  styleUrls: ['./seek-progress-control.component.css']
})
export class SeekProgressControlComponent implements AfterViewInit, OnDestroy {
  curTimePercent = 0;
  bufTimePercent = 0;
